...
ndvi_data = pd.read_csv('Data/Veg/VC_HIF_nearest_interpolation.csv', header=0)
...
# cbar.set_label(r'HIF $\Delta$FVC ($\times 10^{-2}\ \mathrm{yr^{-1}}$)', fontsize=16)
cbar.set_label(r'HIF $\Delta$FVC (% yr$^{-1}$)', fontsize=18)
...
# ======================
# ======================
plt.savefig('HIF_FVC.png', dpi=500, bbox_inches='tight')
plt.show()
